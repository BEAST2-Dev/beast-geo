...
\beast-geo{} requires BEAST\_CLASSIC and BEASTlabs, so if you have not already installed BEASTlabs and BEAST\_CLASSIC, these will be automatically installed as well.
\begin{center}
