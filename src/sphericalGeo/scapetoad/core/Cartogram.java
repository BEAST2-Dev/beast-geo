...
public class Cartogram extends SwingWorker implements Serializable
{
	 ...
	 */
	StatusTracker mCartogramWizard = null;
	...
	public CartogramGrid getGrid() {return mGrid;}
	 ...
	 */
	public Cartogram (StatusTracker cartogramWizard)
	{
	...
	private void updateEnvelope ()
	{
		...
		mCartogramWizard.updateRunningStatus(0, "", "" + masterEnvelope);
		...
		mCartogramWizard.updateRunningStatus(0, "", "" + mEnvelope);
