...
public class AppContext
{
	...
	private static StatusTracker statusTracker = null;

	public static void setStatusTracker(StatusTracker _statusTracker) {
		statusTracker = _statusTracker;
	}
	
	public static StatusTracker getStatusTracker() {
		if (statusTracker != null) {
			return statusTracker;
		}
		return cartogramWizard;
	}
	...
	public static void zoomToFullExtent() throws NoninvertibleTransformException {
		if (layerViewPanel != null) {
			layerViewPanel.getViewport().zoomToFullExtent();
		}
	}
	
	public static void update() throws NoninvertibleTransformException {
		if (layerViewPanel != null) {
