...
public class PostHocLocationSampler extends beast.base.inference.Runnable {
...
//	}
	...
	public static void main(String[] args) throws Exception {
		new beastfx.app.tools.Application(new PostHocLocationSampler(), "Post Hoc Location Sampler", args);
	}
}
